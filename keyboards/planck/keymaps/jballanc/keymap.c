...
[_DATA] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LCTL, KC_LALT, KC_LGUI,  LOWER,   KC_SPC,  KC_SPC,  RAISE, KC_0, KC_DOT, KC_PLUS, KC_ENT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Ctrl | Alt  | GUI  |LowMns|    Space    |RzSlsh| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_DVORAK] = LAYOUT_planck_grid(
    ...
    KC_ESC,  KC_LCTL, KC_LALT, KC_LGUI, LT(_LOWER, KC_MINS), KC_SPC,  KC_SPC,  LT(_RAISE, KC_SLSH), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, KC_MINS, KC_MINS, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, KC_MINS, KC_MINS, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  DATA,     DVORAK,  PLOVER,  _______,
...
static bool shift_interrupted = 0;
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case LOW_MNS:
      ...
      else if (!shift_interrupted && timer_elapsed(scs_timer) < 750) {
        layer_off(_LOWER);
